			...
			<!--
				...
				<fo:marker marker-class-name="module-statement">
					<fo:block font-size="5.5pt" font-weight="normal">
										U.S. Export Classification: EAR: 9E991<fo:block/>
							UTC AEROSPACE SYSTEMS PROPRIETARY - Subject to the restrictions on the title or cover page
									</fo:block>
				</fo:marker>
				<fo:marker marker-class-name="date">
					<xsl:value-of select="concat(/descendant::issueDate[1]/@year,'-',/descendant::issueDate[1]/@month,'-',/descendant::issueDate[1]/@day)"/>
		...
		<fo:block text-align="center" padding-after=".15in">
				<fo:external-graphic content-height="50px" content-width="300px">
					<xsl:attribute name="src">
						<xsl:value-of select="'C:/inetpub/wwwroot/Projects/CMM/Utas/big_utas_logo.cgm'"/>
					</xsl:attribute>
				</fo:external-graphic>
			</fo:block>
			...
			<fo:block padding-after=".1in" font-size="7pt" font-family="arial"  text-align="justify">
				Subject to the EAR, ECCN 9E991 - This information is subject to the export control laws of the United States, specifically including the Export
Administration Regulations (EAR), 15 C.F.R. Part 730 et. seq. Transfer, re-transfer, or disclosure of this data by any means to a non-U.S. person
(individual or company), whether in the United States or abroad, without any required export license or other approval from the U.S. Government is
prohibited, including without limitation any diversion to a military end user or use in a military end use application.
			...
			<fo:block padding-after=".2in" font-size="7pt" font-family="arial" text-align="justify">
				THIS DOCUMENT AND THE INFORMATION CONTAINED HEREIN ARE THE PROPERTY OF HAMILTON SUNDSTRAND
CORPORATION (HSC). RECIPIENT AGREES TO HOLD ALL SUCH INFORMATION IN CONFIDENCE AND AGREES IT SHALL BE USED ONLY FOR
RECIPIENT'S INTERNAL PURPOSES TO MAINTAIN RECIPIENT'S EQUIPMENT OR AS MAY OTHERWISE BE PERMITTED IN AN APPLICABLE
AGREEMENT BETWEEN RECIPIENT AND HSC. THIS DOCUMENT AND THE INFORMATION CONTAINED HEREIN SHALL NOT BE USED FOR
ANY OTHER PURPOSE, INCLUDING THE CREATION, MANUFACTURE, DEVELOPMENT, OR DERIVATION OF ANY REPAIRS, MODIFICATIONS,
SPARE PARTS, DESIGN, OR CONFIGURATION CHANGES, OR TO OBTAIN FAA OR ANY OTHER GOVERNMENT OR REGULATORY APPROVAL
FOR SAME. RECIPIENT AGREES NOT TO DISCLOSE SUCH INFORMATION TO ANY THIRD PARTY, EXCEPT AS MAY OTHERWISE BE
PROVIDED FOR IN AN APPLICABLE AGREEMENT BETWEEN RECIPIENT AND HSC. COPYING OR DISCLOSURE OF THIS DOCUMENT AND THE
INFORMATION CONTAINED HEREIN BY ANYONE WITHOUT HSC'S PRIOR WRITTEN PERMISSION IS NOT AUTHORIZED AND MAY RESULT IN
			...
			<fo:table>
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell>
							<fo:block>
								<fo:external-graphic src="C:/inetpub/wwwroot/Projects/CMM/Utas/big_utas_logo.cgm" content-height=".25in" content-width="200px"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
				...
				<fo:table>
					...
					<fo:table-body>
						<fo:table-row>
							...
							<fo:table-cell >
								<fo:block xsl:use-attribute-sets="bold-normal-text" text-align="right">
									<fo:retrieve-marker retrieve-class-name="date" retrieve-boundary="page-sequence"/>
									<xsl:value-of select="' Page '"/>
									<fo:page-number/>
								</fo:block>
							</fo:table-cell>
