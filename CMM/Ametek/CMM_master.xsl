...
/>
	...
	<xsl:template name="titlePage">
		...
		<fo:block text-align="center" padding-after=".1in">
				<fo:external-graphic content-height="50px" content-width="300px">
					<xsl:attribute name="src">
						<xsl:value-of select="'C:/inetpub/wwwroot/Projects/CMM/Ametek/big_utas_logo.cgm'"/>
					</xsl:attribute>
				</fo:external-graphic>
			</fo:block>
			<fo:block padding-after=".2in" font-size="18pt" font-family="sans-serif" text-align="center" font-weight="bold">
			...
			<fo:block padding-after=".1in" font-size="7pt" font-family="sans-serif"  text-align="justify">
			...
			<fo:table>
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell>
							<fo:block>
								<fo:external-graphic src="C:/inetpub/wwwroot/Projects/CMM/Ametek/big_utas_logo.cgm" content-height=".25in" content-width="200px"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
