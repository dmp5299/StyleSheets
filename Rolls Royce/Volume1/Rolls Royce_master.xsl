...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:bookmark-tree><!--
				...
				<xsl:for-each select="descendant::pmentry[parent::content][./title/text() = 'Main Propulsion Gas Turbine Module (MPGTM) - Operation and  Maintenance - Description (Volume 1 of 6)']">
	...
	<xsl:template name="create_doc_title">
                                ...
                                <fo:block xsl:use-attribute-sets="normal-text" font-weight="bold" font-size="14pt" text-align="center" padding-after="1in">
                                                ...
                                                <xsl:value-of select="'Volume 1 - Description'"/>
...
-->
	...
	<xsl:template match="content"><!--
		...
		<xsl:apply-templates select="pmentry[./title/text() = 'Main Propulsion Gas Turbine Module (MPGTM) - Operation and  Maintenance - Description (Volume 1 of 6)']"/>
	</xsl:template>
		...
		<fo:block padding-after=".15in">
			<xsl:variable name="volume">
				<xsl:variable name="count">
					...
					<xsl:value-of select="$count"/>dave
			</xsl:variable>
