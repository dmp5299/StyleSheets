			...
			<!--
				...
				<fo:marker marker-class-name="module-statement">
					<fo:block font-size="5.5pt" font-weight="normal">
							...
							The export control classification with respoect to this document is contained on the front page. 
									</fo:block>
				</fo:marker>
				<fo:marker marker-class-name="date">
					<xsl:value-of select="concat(descendant::issueDate[1]/@year,'-',descendant::issueDate[1]/@month,'-',descendant::issueDate[1]/@day)"/>
		...
		<fo:block text-align="center" padding-after=".15in">
				<fo:external-graphic content-height="50px" content-width="300px">
					<xsl:attribute name="src">
						<xsl:value-of select="'C:/inetpub/wwwroot/Projects/4.1/CMM/Logo.jpg'"/>
					</xsl:attribute>
				</fo:external-graphic>
			</fo:block>
			...
			<fo:table>
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell>
							<fo:block>
								<fo:external-graphic src="C:/inetpub/wwwroot/Projects/4.1/CMM/Logo.jpg" content-height=".25in" content-width="200px"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
